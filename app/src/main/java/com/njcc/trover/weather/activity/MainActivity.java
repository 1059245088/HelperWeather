...
import com.njcc.trover.weather.bean.WeatherAQI;
import com.njcc.trover.weather.bean.WeatherForecast;
import com.njcc.trover.weather.bean.WeatherRealtime;
import com.njcc.trover.weather.bean.WeatherYesterday;
import com.njcc.trover.weather.bean.WeatherZhiShu;
...
import com.njcc.trover.weather.util.DialogUtils;
import com.njcc.trover.weather.util.HttpUtils;
import com.njcc.trover.weather.util.ServiceUtils;
...
import com.njcc.trover.weather.view.CircleTempView;
import com.njcc.trover.weather.view.TriangleDataDisplayView;
import com.njcc.trover.weather.view.VerticalDataDisplayView;
...
public class MainActivity extends BaseToolBarActivity {
	...
	public static final String ACTION_SHOWDATA = "com.njcc.trover.weather.action_showdata";
	...
	private class MyLocationBaseAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				view = View.inflate(MainActivity.this, R.layout.item_drawer_location, null);
	...
	private class MyForecastBaseAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = View.inflate(MainActivity.this, R.layout.item_forecast, null);
	...
	private class MyLivingIndexBaseAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = View.inflate(MainActivity.this, R.layout.item_living_index_simple, null);
	...
	private void enterAlarmInfoActivity() {
		Intent intent = new Intent(MainActivity.this, AlarmInfoActivity.class);
		AnimationUtils.startActivityWithExplodeAnimation(MainActivity.this, intent);
	}
	...
	private void showVersionChangeLogDialog() {
		...
		if (!isRead) {
			DialogUtils.showAlertDialog(MainActivity.this, VersionUtils.getVersionName(MainActivity.this) + " 版本更新日志:", getString(R.string.version_change_log), "已阅", "", "", new DialogUtils.DialogCallBack() {
				@Override
				public void onPositiveButton(DialogInterface dialog, int which) {
					...
					editor.commit();
					dialog.dismiss();
					DialogUtils.showUseAssistantDialog(MainActivity.this);
				}
	...
	private void initSettings() {
		...
		if (sp.getBoolean(getString(R.string.auto_update_weather), SettingsActivity.AUTO_UPDATE_DEFAULT) && !ServiceUtils.isServiceRunning(this, "hanjie.app.pureweather.services.AutoUpdateService")) {
			Intent autoUpdateWeatherIntent = new Intent(MainActivity.this, AutoUpdateService.class);
		...
		new AsyncTask<String, Void, Boolean>() {
			...
			protected Boolean doInBackground(String... params) {
				try {
					...
					WeatherDataParser.parserToDB(MainActivity.this, s, areaId);
			...
			protected Boolean doInBackground(ArrayList... params) {
				...
				for (String id : areaIdList) {
					try {
						...
						WeatherDataParser.parserToDB(MainActivity.this, s, id);
						dao.setCache(id, 1);
